...
import com.eladapp.elachat.widget.SendView;
import com.eladapp.elachat.widget.VideoProgressBar;
    ...
    private View.OnClickListener selectClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
           ...
           // Toast.makeText(VideoRecorderActivity.this, "文件以保存至：" + path, Toast.LENGTH_SHORT).show();
            send.stopAnim();
           // recordLayout.setVisibility(View.VISIBLE);
            Intent intent = new Intent(VideoRecorderActivity.this, ChatActivity.class);
